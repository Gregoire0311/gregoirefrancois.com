...
export const projects: Project[] = [
  ...
  {
    slug: "the-historical-relics",
    title: "The Historical Relics",
    tagline: "E-commerce website for historical collectibles and antiques",
    ...
    repoUrl: "#",
    liveUrl: "#",
    description: "A modern e-commerce website developed in TypeScript for selling historical collectibles and antiques (medals, vintage items, memorabilia) with a secure and intuitive interface.",
    impact: [
      "Modern and responsive user interface",
